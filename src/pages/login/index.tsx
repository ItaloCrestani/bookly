  ...
  return(
   <div className="flex min-h-dvh">
    ...
    <div className="flex flex-col flex-1 justify-center bg-[#060A11] border-[#191D27] lg:px-12 lg:py-6 lg:border-l-2 lg:-ml-8 lg:rounded-l-3xl">
      <div className="flex flex-col flex-1 justify-center w-full px-4 py-6 bg-[#0C111A] border-[#191D27] md:border md:rounded-4xl md:px-24">
        <div className="text-white">
          <h1 className="text-2xl font-medium">Faça seu Login</h1>
          <p className="text-[#8C929B] text-[14px] mt-2">Entre na conta para acessar sua estante.</p>

          <form className="mt-10" onSubmit={handleSubmit(handleRegister)}>
            <p className="text-[14px] text-[#dbe0ea] mb-2">E-mail</p>
            ...
            <p className="text-[14px] text-[#dbe0ea] mt-10 mb-2">Senha</p>
            <div className="flex w-full gap-3 items-center p-4 bg-[#060A11] border border-[#191D27] rounded-xl">
            ...
            <p className="flex justify-center gap-2 mt-6 text-[#8C929B] text-[14px]">
              Ainda não possui uma conta?<Link to="/register" className="text-[#8C59FE]">Criar conta</Link>
            </p>
